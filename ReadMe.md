...
## Source
You need to download all recursive submodules so download with: `git clone --recurse-submodules https://github.com/RydeTec/rcce2.git`

If you forgot to download submodules just do it with `git submodule update --init --recursive`
