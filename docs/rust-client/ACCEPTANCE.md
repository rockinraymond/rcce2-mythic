...
Counting concrete criteria (excluding DEFERRED): **DONE ≈ 61, PARTIAL ≈ 24** (Phases 1-5 + breadth incl. ANIM-8, PRJ-1, CHAT-2/3/4, ENV-5/6, HUD-8, SPL-7, QST-1/2, PTY-1/2, TGT-7, HUD-3, CAM-5, MOVE-7+ANIM-7 jump, CAM-4, MOVE-6, ANIM-6, 2026-06-01). **All four headline play-test gaps are now closed.** Of the 9 remaining MISSING rows, most are **live-only-with-content** (MOVE-8 / ANIM-4 / ANIM-5 / CAM-6 / ENV-4 = water·swim·ride, TRD-3 = 2 players, TGT-8 = scripted text dialog, SPL-8 = own-cast FX). The non-deferred implementable remainder is **SPL-4 (memorise)** — the last one.
