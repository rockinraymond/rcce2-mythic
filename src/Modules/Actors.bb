...
Function GetActorTradeValue(AI.ActorInstance, ItemValue, isBuying = 0)
	...
	ModdedValue = Int(ItemFloatVal * PriceMod)
...
Function GetPlayerRaceInfo$(PlayerRace$)
	...
	Select PlayerRace$
		case "Human"
			RaceDescription$ = "Humans are the most populous race in the Western Lands. They have the potential to be adept in many different things, because of this they do not have any bonuses or penalties to thier attributes or skills nor any notable special abilites. However, Humans level up the fastest of all the races of the Western Lands."
		case "Elf"
			RaceDescription$ = "Elves are perhaps the oldest of the civilized races of the Western Lands. They contain a natural affinity for magic, however they have seem to lost faith in thier deity long ago. Elves may be frail but can be skilled warriors, particulary with swords and bows. They can cast arcane spells in Leather and Chainmail armor and have moderate resistances to spells, wands and paralysis."
		case "Dwarf"
			RaceDescription$ = "Dwarves are hardy yet reserved folk known for both craftsmanship and mechnical ability. They are fierce fighters who tend to favor heaiver weapons and armor. They are typically not fond of magic but possess high resistences to spells and wands along with paralysis, poison, death ray and dragon breath. They can search for and disarm traps in any kind of armor but thier short stature prevents them from wielding two-hand swords, polearms and long bows."
		case "Halfling"
		...
		case "Gnome"
			RaceDescription$ = "Gnomes are a whimiscal race of curious minds who take great interest in both magic and technology. Gnomes frequently pratice magic and are even able to cast arcane spells in leather armor. Their hardiness grants high resistences to poison, death ray and dragon breath. Due to thier stature they must wield medium sized weapons with two hands and are unable to use large weapons at all."
		case "Half Orc"
