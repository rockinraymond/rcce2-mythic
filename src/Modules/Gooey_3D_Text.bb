...
Function GY_TextWidth#(TextHandle, Dat$)
	...
	; Guard divide-by-zero on MaxLength (caller passes the cap as a
	; Create3DText param; 0 would divide-by-zero on every call) and on
...
Function GY_Set3DText(TextHandle, Dat$)
	...
	; Same divide-by-zero guards as GY_TextWidth -- the For loop at the
