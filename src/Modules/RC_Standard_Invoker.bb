Function BVM_InitStringConst_BVM_MAIN_CMD_SET_DEF_$()
	...
	s = s + "Function ACTORAGGRESSIVENESS<BVM_ACTORAGGRESSIVENESS>%(PARAM1%, PARAM2% = 0, PARAM3% = 0)"+Chr(10)
	...
	s = s + "Function ZZSETITEMDAMAGETYPE<BVM_ZZSETITEMDAMAGETYPE>%(PARAM1%,PARAM2$)"+Chr(10)
	...
	s = s + "Function ITEMATTRIBUTE<BVM_ITEMATTRIBUTE>%(PARAM1%, PARAM2$, PARAM3% = 0)"+Chr(10)
	s = s + "Function ZZLASTSPAWNEDITEM<BVM_ZZLASTSPAWNEDITEM>%(PARAM1$, PARAM2% = 0)"+Chr(10)
	s = s + "Function ZZSETITEMATTRIBUTE<BVM_ZZSETITEMATTRIBUTE>%(PARAM1%, PARAM2$, PARAM3%)"+Chr(10)
	s = s + "Function ZZSETITEMRESISTANCE<BVM_ZZSETITEMRESISTANCE>%(PARAM1%, PARAM2$, PARAM3%)"+Chr(10)
	...
	s = s + "Function ADDACTOREFFECT<BVM_ADDACTOREFFECT>(PARAM1%, PARAM2$, PARAM3$, PARAM4%, PARAM5%, PARAM6%, PARAM7%=0)"+Chr(10)
	...
	s = s + "Function ZZRUNABILITYCOOLDOWN<BVM_ZZRUNABILITYCOOLDOWN>(PARAM1%, PARAM2$)"+Chr(10)
	s = s + "Function SETABILITYLEVEL<BVM_SETABILITYLEVEL>(PARAM1%, PARAM2$, PARAM3%)"+Chr(10)
	s = s + "Function ANIMATEACTOR<BVM_ANIMATEACTOR>(PARAM1%, PARAM2$, PARAM3#, PARAM4%=0, PARAM5%=0)"+Chr(10)
	...
	s = s + "Function ZZADDSKILLXP<BVM_ZZADDSKILLXP>(PARAM1%, PARAM2$, PARAM3%)"+Chr(10)
	...
	s = s + "Function ATTRIBUTE<BVM_ATTRIBUTE>%(PARAM1%, PARAM2$, PARAM3% = 0)"+Chr(10)
	s = s + "Function ZZACTORINVMASS<BVM_ZZACTORINVMASS>%(PARAM1%)"+Chr(10)
	...
	Repeat 
		...
		Select ret%
			...
			Case 268
				...
				iparam1% = BVM_PopInt()
				iparam0% = BVM_PopInt()
				BVM_PushInt(BVM_ACTORAGGRESSIVENESS(iparam0%, iparam1%, iparam2%))
			Case 269
				iparam0% = BVM_PopInt()
			...
			Case 315
				...
				sparam1$ = BVM_PopString()
				iparam0% = BVM_PopInt()
				BVM_ADDACTOREFFECT(iparam0%, sparam1$, sparam2$, iparam3%, iparam4%, iparam5%, iparam6%)
			Case 316
				iparam4% = BVM_PopInt()
				iparam3% = BVM_PopInt()
				...
				sparam1$ = BVM_PopString()
				iparam0% = BVM_PopInt()
				BVM_ANIMATEACTOR(iparam0%, sparam1$, fparam2#, iparam3%,iparam4%)
			Case 317
				sparam0$ = BVM_PopString()
			...
			Case 324
				...
				sparam1$ = BVM_PopString()
				iparam0% = BVM_PopInt()
				BVM_PushInt(BVM_ATTRIBUTE(iparam0%, sparam1$, iparam2%))
			Case 325
				iparam1% = BVM_PopInt()
				iparam0% = BVM_PopInt()
			...
			Case 376
				...
				iparam1% = BVM_PopInt()
				iparam0% = BVM_PopInt()
				BVM_PushInt(BVM_FIREPROJECTILE(iparam0%, iparam1%, sparam2$))
			Case 377
				iparam1% = BVM_PopInt()
				sparam0$ = BVM_PopString()
			...
			Case 403
				...
				sparam1$ = BVM_PopString()
				iparam0% = BVM_PopInt()
				BVM_PushInt(BVM_ITEMATTRIBUTE(iparam0%, sparam1$,iparam2%))
			Case 404
				iparam0% = BVM_PopInt()
			...
			Case 579
				iparam0% = BVM_PopInt()
				BVM_PushInt(BVM_ZZACTORINVMASS(iparam0%))
			Case 580
				iparam2% = BVM_PopInt()
				sparam1$ = BVM_PopString()
				iparam0% = BVM_PopInt()
			...
			Case 588
				sparam1$ = BVM_PopString()
				iparam0% = BVM_PopInt()
				BVM_PushInt(BVM_ZZSETITEMDAMAGETYPE(iparam0%, sparam1$))
			Case 589
				iparam2% = BVM_PopInt()
				sparam1$ = BVM_PopString()
				iparam0% = BVM_PopInt()
				BVM_PushInt(BVM_ZZSETITEMRESISTANCE(iparam0%, sparam1$, iparam2%))
			Default 
